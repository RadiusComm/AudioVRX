/*
  ...
  1. New Tables
    - `roleplay_scenarios`
      - Stores scenario definitions with objectives and success criteria
      - Includes conversation intents and branching logic
      - Links to personas for AI responses
    
    - `roleplay_sessions`
      - Tracks active roleplay sessions
      - Stores conversation transcripts and feedback
      - Records user performance metrics

  2. Security
    - Enable RLS on both tables
    - Add policies for public access, user management, and admin control
